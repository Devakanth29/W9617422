...
package uk.ac.tees.mad.w9617422.data.remote

import uk.ac.tees.mad.w9617422.BuildConfig
import uk.ac.tees.mad.w9617422.data.remote.response.*
...
interface ApiService {
    ...
    suspend fun getTrendingMovies(
        ...
        @Query("api_key") apiKey: String = BuildConfig.WatchWave_API_KEY,
