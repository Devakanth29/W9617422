...
val Purple500 = Color(0xFF6200EE)
val Purple700 = Color(0xFF3700B3)
val Teal200 = Color(0xFFABF1F1)

val AppPrimaryColor = Color(0xFF88CDEC)
val AppOnPrimaryColor = Color.Black.copy(alpha = 0.78F)
val ButtonColor = Color(0xFF18FFFF)
val SeeMore = Color(0xFF7E7E7E)
val background = Color(0xFFD8F1F1)
